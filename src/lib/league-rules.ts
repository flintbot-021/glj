...
export const GRUDGE_MATCH_COPY =
  'Challenge one player outside your group — the match opens immediately. Either of you records the result; the other confirms once. You may issue 1 challenge and receive up to 3. Win as challenger: +3. Win as challenged: +1. Halve: +1 each. Settled points bank on the group table and count toward Pts after you have played 3 group games (same for every group, including the group of five).'
